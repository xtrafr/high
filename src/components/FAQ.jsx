      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300"
            >
              <button
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300"
          >
