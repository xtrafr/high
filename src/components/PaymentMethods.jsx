      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8">
          {paymentMethods.map((method, index) => (
            ...
            >
              <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-2xl blur-lg opacity-0 group-hover:opacity-30 transition-all duration-500"></div>
              <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 group-hover:border-purple-500/50 rounded-2xl p-6 md:p-8 transition-all duration-500 flex items-center justify-center h-32 md:h-40">
                <img 
                  src={method.logo} 
                  alt={method.name}
