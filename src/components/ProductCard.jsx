  ...
  return (
    ...
    >
      <div 
        ...
        className="relative h-full bg-gradient-to-b from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-white/10 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.08] overflow-hidden flex flex-col"
      >
        <motion.div
        ...
        <div className="relative z-10 flex-1 flex flex-col">
          ...
          <div className="flex justify-center mt-auto">
            <button
              ...
              className="w-full max-w-xs py-3 md:py-4 text-sm md:text-base bg-white text-black font-semibold rounded-full hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 hover:shadow-2xl hover:shadow-white/20 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
